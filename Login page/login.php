	...
	<div class="section back_xlite" id="intro_section_user">
		<div class="section_content">
			<div class="section_inside">
			    <h2 style="color:#FFFFFF">YOUR HEADING 1</h2><p style="color:#FFFFFF">YOUR TEXT HERE</p><br><h2 style="color:#FFFFFF">YOUR HEADING 2</h2><p style="color:#FFFFFF">YOUR TEXT HERE</p><br><br>
				<div id="last_active">
